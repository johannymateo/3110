// Johanny Mateo
// CISC 3110 - Assignment 2
// Creating a Mini Database Using Arrays
...
// accepts prodIDArr, priceArr, QOHArr, and counter of current arr loc
void addItem(string [], double [], int [], int &);
// fn to find index of productID, retuns index as int,
// accepts prodIDArr, prodID, and up to where is the arr filled
int findID(string [], string, int);
// fn to update price, returns nothing
// accepts prodIDArr, priceArr, and array fill loc
void updateItem(string [], double [], int);
// fn to update quantity, returns nothing
// accepts prodIDArr, QOHArr, and array fill loc
void updateItem(string [], int [], int);
// fn to display item, returns nothing
// accepts prodIDArr, priceArr, QOHArr, and array fill loc
void displayItem(string [], double [], int [], int);
// fn to print DB, returns nothing
// accepts prodIDArr, priceArr, QOHArr, and array fill loc
void printDB(string [], double [], int [], int);
...
// accepts prodIDArr, prodID by reference, and arr insert loc
bool dupeCheck(string [], string &, int);
...
void addItem(string prodIDArr[], double priceArr[], int QOHArr[], int &items)
{
    ...
    if (items < DBMAX) {        // makes sure not to go out of bounds in array
        ...
        while ((prodID != "0") && !dupe) {
            ...
            if (!dupe) {
                prodIDArr[items] = prodID;  // there is no dupe, add this prodID
...
int findID(string prodIDArr[], string findID, int filled)
{
...
void updateItem(string prodIDArr[], double priceArr[], int filled)
{
...
void updateItem(string prodIDArr[], int QOHArr[], int filled)
{
    int editLoc;            // the index of item to be updated
    string editID;
...
void displayItem(string prodIDArr[], double priceArr[], int QOHArr[], int filled)
{
...
void printDB(string prodIDArr[], double priceArr[], int QOHArr[], int filled)
{
...
bool dupeCheck(string prodIDArr[], string &prodID, int currLoc)
{
